        ...
        return args -> {
            if (userRepository.count() == 0) {
                List<TransactionSeed> transactionSeeds = List.of(
                        new TransactionSeed("Salary", new BigDecimal("15000.00"), 30),
                        new TransactionSeed("Rent", new BigDecimal("-3500.00"), 28),
                        new TransactionSeed("Condominium Fee", new BigDecimal("-600.00"), 27),
                        new TransactionSeed("Internet", new BigDecimal("-150.00"), 25),
                        new TransactionSeed("Supermarket", new BigDecimal("-800.00"), 24),
                        new TransactionSeed("Shell Gas Station", new BigDecimal("-250.00"), 22),
                        ...
                        new TransactionSeed("Pharmacy", new BigDecimal("-90.00"), 18),
                        new TransactionSeed("Transfer Received", new BigDecimal("450.00"), 16),
                        new TransactionSeed("Japanese Restaurant", new BigDecimal("-200.00"), 15),
                        ...
                        new TransactionSeed("Bookstore", new BigDecimal("-140.00"), 8),
                        new TransactionSeed("Coffee Shop", new BigDecimal("-35.00"), 7),
                        new TransactionSeed("Cinema", new BigDecimal("-70.00"), 5),
                        new TransactionSeed("Japan Trip Savings", new BigDecimal("-1000.00"), 3),
